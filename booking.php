                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $query = mysqli_query($conn, "SELECT * FROM booking JOIN users ON booking.id_pemilik = users.id");
                                            while ($data = mysqli_fetch_array($query)) {
                                            ?>
                                                <tr>
                                                    <td><?php echo $no++; ?></td>
                                                    <td><?php echo $data['merek']; ?></td>
                                                    <td><?php echo $data['jenis_servis']; ?></td>
                    ...
                    <form action="tambahbooking.php" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Merek Laptop</label>
                                <input type="text" class="form-control" placeholder="Masukkan Merek Laptop" name="merek">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Jenis Servis</label>
                                <input type="text" class="form-control" placeholder="Masukkan Jenis Perawatan" name="jenis_servis">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Nama Pemilik</label>
                                <select class="custom-select rounded-0" id="exampleSelectRounded0" name="id_pemilik">
                                    <?php
